...
// Validate ../../src/app/api/test_print/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/test_print">> = Specific
  const handler = {} as typeof import("../../src/app/api/test_print/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
